...
(function() {
  ...
  var QRCodeManager = function(element) {
    ...
    var imageDecodingWorker = new Worker('scripts/jsqrcode/qrworker.js');
    ...
    this.detectQRCode = function(imageData, callback) {
      ...
      imageDecodingWorker.postMessage(imageData);

      imageDecodingWorker.onmessage = function(result) {
        var url = result.data;
        if(url !== undefined) {
          self.currentUrl = url;
        }
      ...
      imageDecodingWorker.onerror = function(error) {
